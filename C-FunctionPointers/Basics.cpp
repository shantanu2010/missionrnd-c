...
char * subString(char *str, int a, int b){
	...
	char* resString = (char*)calloc((b - a)+2, sizeof(char));
...
void task3() {
	...
	char*(*pointer)(char*, int, int) = &subString;
